...
def calculateJ2J3(Ex, Ey, Ez, J1, DH_table):
    ...
    angleBCE = math.acos((BC**2 + CE**2 - BE**2)/(2*BC*CE))
...
def calculateJ4J5J6(EEx, EEy, EEz, x1, x2, x3, J1, J2, J3, DH_table):
    ...
    return J4, J4, J5, J5p, J6, J6p


def InverseKinemetics(EulerAngle, Position, DH_table):
    ...
    J2s[0], J2s[1], J3s[0], J3s[1] = calculateJ2J3(
        Ex, Ey, Ez, J1s[0], DH_table)
    J2s[2], J2s[3], J3s[2], J3s[3] = calculateJ2J3(
        Ex, Ey, Ez, J1s[1], DH_table)
    J4s[0], J4s[1], J5s[0], J5s[1], J6s[0], J6s[1] = calculateJ4J5J6(
        EEx, EEy, EEz, x1, x2, x3, J1s[0], J2s[0], J3s[0], DH_table)
    J4s[2], J4s[3], J5s[2], J5s[3], J6s[2], J6s[3] = calculateJ4J5J6(
        EEx, EEy, EEz, x1, x2, x3, J1s[0], J2s[1], J3s[1], DH_table)
    ...
    J4s[4], J4s[5], J5s[4], J5s[5], J6s[4], J6s[5] = calculateJ4J5J6(
        EEx, EEy, EEz, x1, x2, x3, J1s[1], J2s[2], J3s[2], DH_table)
    J4s[6], J4s[7], J5s[6], J5s[7], J6s[6], J6s[7] = calculateJ4J5J6(
        EEx, EEy, EEz, x1, x2, x3, J1s[1], J2s[3], J3s[3], DH_table)
    ...
    return JointAngle, SingularFlag
